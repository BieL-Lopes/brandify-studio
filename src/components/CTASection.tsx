    ...
    <section className="py-20 bg-hero-pattern relative overflow-hidden">
      ...
      <div className="container relative z-10 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Heading */}
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-6 px-4">
            Quer destacar sua marca com brindes personalizados de qualidade?
          </h2>

          <p className="text-lg sm:text-xl text-primary/80 mb-8 px-4">
          ...
          <div className="flex justify-center items-center mb-10 px-4">
            <div className="flex items-center gap-3 text-primary">
              ...
              <div className="text-left">
                ...
                <p className="font-bold text-base sm:text-lg">(61) 99102-9997</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-10 px-4">
            <div className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-white/80 rounded-full text-primary text-xs sm:text-sm font-medium">
              <Truck className="w-4 h-4 text-accent flex-shrink-0" />
              <span className="whitespace-nowrap">Atendemos todo o Brasil</span>
            </div>
            <div className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-white/80 rounded-full text-primary text-xs sm:text-sm font-medium">
          ...
          {/* CTA Button */}
          <div className="px-4">
            <Button variant="hero" size="xl" asChild className="animate-pulse-soft w-full sm:w-auto">
